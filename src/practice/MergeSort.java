...
public class MergeSort {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		//Recurssive
		Recursive_mergeSort(data, 0, data.length - 1);
		System.out.println("Sort by Recurrsion :");
		for (int i = 0; i < 9; i++) {
			System.out.print(data[i] + " ");
		}
		System.out.println();
		//Non-recurssive
		System.out.println("Sort by non-recurrsion :");
	...
	public static void Recursive_mergeSort(int data[], int start, int end) {

		if (start < end) {
			int middle = (end + start) / 2;
			Recursive_mergeSort(data, start, middle);
			Recursive_mergeSort(data, middle + 1, end);
